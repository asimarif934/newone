        ...
        {showcaseProducts.map((product) => {
          return (
            <Link 
              ...
              className="block"
            >
              <div className="rounded-2xl border border-border/50 bg-card text-card-foreground shadow-xl p-4 sm:p-6 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 hover:-translate-y-1 cursor-pointer">
                {/* Image + overlay items */}
                <div className="relative aspect-square overflow-hidden rounded-xl bg-muted">
                  ...
                  {/* Discount (TOP-LEFT) — inside image container with z-index */}
                  {product.discount && (
                  ...
                  {/* Badge (TOP-RIGHT) — inside image container with z-index */}
                  {product.badge && (
                ...
                {/* Rating row (one star + rating + reviews) */}
                ...
                {/* Title */}
                <h3 className="mt-2 text-lg font-semibold hover:text-primary transition-colors duration-300">{product.name}</h3>
