...
const AuthPopup = ({ isOpen, onClose, isManualSignup = false }: AuthPopupProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 safe-area-top safe-area-bottom">
      ...
      {/* Popup Container */}
      <div className="relative bg-card/95 backdrop-blur-md border border-primary/20 rounded-2xl w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto shadow-2xl animate-in fade-in-0 zoom-in-95 duration-300 max-h-[90vh] sm:max-h-[85vh] flex flex-col">
        {/* Close Button */}
        <Button
          variant="ghost"
          size="icon"
